...
Is there a dress code for dining at your restaurant?            <Image
      ...
      <div className="mx-auto">
        <div className="flex  overflow-hidden   gap-4">
          <Image src={'/images/eventDining.png'} alt="diningroom" width={220} height={400} className="transform scale-100 hover:scale-110 transition-transform duration-500 desktop:w-[380px] rounded-md"/>
          <Image src={'/images/eventblack.png'} alt="diningroom" width={110} height={135} className="transform scale-100 hover:scale-110 transition-transform duration-500 desktop:w-[200px] tablet:mt-0 mx-auto rounded-md"/>

        </div>
        <div className="flex pt-4 overflow-hidden  gap-4">
          <Image src={'/images/eventred.png'} alt="diningroom" width={160} height={300} className="transform scale-100 hover:scale-110 transition-transform duration-500 desktop:w-[250px] mx-auto rounded-md"/>
          <Image src={'/images/eventDining4.png'} alt="diningroom" width={170} height={300} className="transform  scale-100 hover:scale-110 transition-transform duration-500 desktop:w-[330px] tablet:mt-0 rounded-md"/>
