          ...
          <div className="py-8">
            ...
            <div className="bg-[#0d1634] my-8 flex items-center gap-4 desktop:gap-8 rounded-xl w-full desktop:max-w-[450px] shadow-primaryDark py-3 px-4">
              ...
              <svg width="34" height="31" viewBox="0 0 34 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path fillRule="evenodd" clipRule="evenodd" d="M9.08301 8.33203C9.08301 7.64168 9.64265 7.08203 10.333 7.08203L13.6663 7.08203C14.3567 7.08203 14.9163 7.64168 14.9163 8.33203C14.9163 9.02239 14.3567 9.58203 13.6663 9.58203L10.333 9.58203C9.64265 9.58203 9.08301 9.02239 9.08301 8.33203Z" fill="white"></path>
                                                <path fillRule="evenodd" clipRule="evenodd" d="M5.75 15C5.75 14.3096 6.30964 13.75 7 13.75L13.6667 13.75C14.357 13.75 14.9167 14.3096 14.9167 15C14.9167 15.6904 14.357 16.25 13.6667 16.25H7C6.30964 16.25 5.75 15.6904 5.75 15Z" fill="white"></path>
                                            </svg>
