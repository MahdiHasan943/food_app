export function html({ url, text }) {
    ...
    LilyanE James Online Shoping.</h2>
    <p  style="text-align: center; text-transform: capitalize; color:#000;">Congratulations! You're almost set to start visiting  LilyanE James.
